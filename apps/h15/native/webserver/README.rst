...
The application currently works with the IMX678 sensor. For best IQ settings, use it with the Theia SL410M lens on which it was tuned. Compatibility with other sensors and lenses is not guaranteed and may require specific adjustments.
