...
class Resource
{
  ...
  public:
    ...
    {
        subscribe_callback(EventType::RESET_CONFIG,
    ...
    {
        m_event_bus->subscribe(resource_type, EventPriority::EVENT_PRIORITY_HIGH, callback);
    }
    ...
    {
        m_event_bus->subscribe(resource_types, EventPriority::EVENT_PRIORITY_HIGH, callback);
    }
    ...
    {
        m_event_bus->subscribe(resource_types, priority, callback);
    }
};
} // namespace resources
} // namespace webserver
