...
webserver::resources::FrontendResource::FrontendResource(std::shared_ptr<EventBus> event_bus, std::shared_ptr<webserver::resources::AiResource> ai_res, std::shared_ptr<webserver::resources::IspResource> isp_res, std::shared_ptr<webserver::resources::ConfigResource> configs) : Resource(event_bus)
{
...
void webserver::resources::FrontendResource::update_frontend_config()
{
    ...
    if (at_least_one_stream_framerate_changed || rotate_state_changed || at_least_one_stream_resolution_changed){
