...
#include "stage.hpp"
#include "buffer.hpp"
#include "file_sink_module.hpp"

#define FILE_QUEUE_SIZE_DEFAULT (1)

class FileSinkStage : public ConnectedStage
{
  private:
    ...
    class Builder
    {
      ...
      public:
        ...
        std::shared_ptr<FileSinkStage> buildptr() const
        {
            ...
            return std::make_shared<FileSinkStage>(m_stage_name.value(), m_queue_size, m_leaky, m_print_fps);
        }
    };
