...
class AppControlServiceExt : public CameraAppExtension
{
  public:
    // Error types
    enum Error
    ...
    tl::expected<bool, Error> set_clip_embedding_refresh_rate(size_t refresh_rate)
    {
        ...
        auto traffic_control_stage =
            std::static_pointer_cast<TrackerTrafficCtrlStage>(pipeline->get_stage_by_name(app::stage::tracker_traffic_ctrl));
