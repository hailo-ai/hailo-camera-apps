...
class QualityCheckStage : public ConnectedStage
{
  ...
  public:
    ...
    inline QualityCheckStage(std::string name, bool enable = true, size_t queue_size = QUALITY_QUEUE_SIZE_DEFAULT,
        ...
        : ConnectedStage(name, queue_size, leaky, print_fps), m_enabled(enable)
    {
    }
    ...
    class Builder
    {
      ...
      public:
        ...
        std::shared_ptr<QualityCheckStage> buildptr() const
        {
            ...
            return std::make_shared<QualityCheckStage>(m_stage_name.value(), m_enable, m_queue_size, m_leaky,
                                                       m_print_fps);
        }
    };
