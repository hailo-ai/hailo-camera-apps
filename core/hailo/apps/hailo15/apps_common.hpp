...
const std::map<StreamResolution, std::pair<int, int>> resolutionMap = {
    {StreamResolution::SD, {640, 360}},    {StreamResolution::ED, {720, 480}},
    {StreamResolution::HD, {1280, 720}},   {StreamResolution::FHD, {1920, 1080}},
    {StreamResolution::QHD, {2592, 1944}}, {StreamResolution::UHD_4K, {3840, 2160}}};
...
void fps_measurements_callback(GstElement *fpsdisplaysink, gdouble fps, gdouble droprate, gdouble avgfps,
                               gpointer udata);
