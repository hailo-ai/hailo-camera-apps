...
TEST_CASE("Kalman filter can initiate a tracklet from an unassociated measurement.", "[kalman_initiate]")
{
    ...
    SECTION("Standard inputs initiate safely")
    {
        ...
        TrackerTypes::KAL_COVA expected_covariance = {
            {24.48826587, 0., 0., 0., 0., 0., 0., 0.}, {0., 24.48826587, 0., 0., 0., 0., 0., 0.},
            {0., 0., 24.48826587, 0., 0., 0., 0., 0.}, {0., 0., 0., 24.48826587, 0., 0., 0., 0.},
            {0., 0., 0., 0., 6.12206647, 0., 0., 0.},  {0., 0., 0., 0., 0., 6.12206647, 0., 0.},
            {0., 0., 0., 0., 0., 0., 1.53051662, 0.},  {0., 0., 0., 0., 0., 0., 0., 1.53051662}};
...
TEST_CASE("Kalman filter can project state distribution to measurement space.", "[kalman_project]")
{
    ...
    TrackerTypes::KAL_MEAN standard_input_mean_1 = {
        {141.366903, 670.522250, 0.305809785, 247.428100, 0.0, 0.0, 0.0, 0.0}};
    TrackerTypes::KAL_COVA standard_input_covariance_1 = {
        {36.7323988, 0., 0., 0., 6.12206647, 0., 0., 0.},  {0., 36.7323988, 0., 0., 0., 6.12206647, 0., 0.},
        {0., 0., 32.14084895, 0., 0., 0., 1.53051662, 0.}, {0., 0., 0., 32.14084895, 0., 0., 0., 1.53051662},
        {6.12206647, 0., 0., 0., 6.18328713, 0., 0., 0.},  {0., 6.12206647, 0., 0., 0., 6.18328713, 0., 0.},
        {0., 0., 1.53051662, 0., 0., 0., 1.59173728, 0.},  {0., 0., 0., 1.53051662, 0., 0., 0., 1.59173728}};

    SECTION("Standard inputs projects safely")
    {
        // Expected mean and covariance, taken from adk tracker on standard_input_1
        TrackerTypes::KAL_HMEAN expected_mean = {{141.366903, 670.522250, 0.305809785, 247.428100}};
        TrackerTypes::KAL_HCOVA expected_covariance = {
            {42.85446527, 0., 0., 0.}, {0., 42.85446527, 0., 0.}, {0., 0., 38.26291542, 0.}, {0., 0., 0., 38.26291542}};
...
TEST_CASE("Kalman filter can update a tracklet based on a newly measured detection.", "[kalman_update]")
{
    ...
    {
        // Expected mean and covariance, taken from adk tracker on standard_input_1
        TrackerTypes::KAL_MEAN expected_mean = {{141.531433, 670.586677, 0.305696133, 247.128161, 0.0274217143,
                                                 0.0107378571, -0.00000541196597, -0.0142828000}};
        TrackerTypes::KAL_COVA expected_covariance = {
            {5.24748554, 0., 0., 0., 0.87458092, 0., 0., 0.}, {0., 5.24748554, 0., 0., 0., 0.87458092, 0., 0.},
            {0., 0., 5.14253583, 0., 0., 0., 0.24488266, 0.}, {0., 0., 0., 5.14253583, 0., 0., 0., 0.24488266},
            {0.87458092, 0., 0., 0., 5.30870621, 0., 0., 0.}, {0., 0.87458092, 0., 0., 0., 5.30870621, 0., 0.},
            {0., 0., 0.24488266, 0., 0., 0., 1.53051662, 0.}, {0., 0., 0., 0.24488266, 0., 0., 0., 1.53051662}};

        // Update using the standard inputs
        auto projection_results =
            kalman_filter.update(standard_input_mean_1, standard_input_covariance_1, standard_input_measurements_1);
    ...
    SECTION("Blank measurements produce drastic changes in mean, but not covariance")
    {
        ...
        TrackerTypes::KAL_MEAN expected_mean = {
            {20.1952719, 95.7888929, 0.0489295656, 39.5884960, -20.1952719, -95.7888929, -0.0122323914, -9.89712402}};
        TrackerTypes::KAL_COVA expected_covariance = {
            {5.24748554, 0., 0., 0., 0.87458092, 0., 0., 0.}, {0., 5.24748554, 0., 0., 0., 0.87458092, 0., 0.},
            {0., 0., 5.14253583, 0., 0., 0., 0.24488266, 0.}, {0., 0., 0., 5.14253583, 0., 0., 0., 0.24488266},
            {0.87458092, 0., 0., 0., 5.30870621, 0., 0., 0.}, {0., 0.87458092, 0., 0., 0., 5.30870621, 0., 0.},
        ...
        auto projection_results =
            kalman_filter.update(standard_input_mean_1, standard_input_covariance_1, blank_input_measurement);
        TrackerTypes::KAL_MEAN updated_mean = projection_results.first;
        TrackerTypes::KAL_COVA updated_covariance = projection_results.second;
 ...
 *
 */
TEST_CASE("Kalman filter can compute gating distance between state distribution and measurements.",
          "[kalman_gating_distance]")
{
    ...
    SECTION("Standard measurements get reasonable distances")
    {
        ...
        xt::xarray<float> distance_results = kalman_filter.gating_distance(
            standard_input_mean_1, standard_input_covariance_1, {standard_input_measurements_1});
    ...
    SECTION("Blank measurements get large invalid distances")
    {
        ...
        // Compute the gating distance using the standard inputs
        xt::xarray<float> distance_results = kalman_filter.gating_distance(
            standard_input_mean_1, standard_input_covariance_1, {blank_input_measurements_1});
