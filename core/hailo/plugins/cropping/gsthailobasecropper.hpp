...
#define GST_HAILO_BASE_CROPPER(obj)                                                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_HAILO_BASE_CROPPER, GstHailoBaseCropper))
#define GST_HAILO_BASE_CROPPER_CLASS(klass)                                                                            \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_HAILO_BASE_CROPPER, GstHailoBaseCropperClass))
...
#define HAILO_BASE_CROPPER_VIDEO_CAPS GST_VIDEO_CAPS_MAKE(HAILO_BASE_CROPPER_SUPPORTED_FORMATS)
...
struct _GstHailoBaseCropperClass
{
    ...
    void (*resize)(GstHailoBaseCropper *basecropper, std::vector<cv::Mat> &cropped_image,
                   std::vector<cv::Mat> &resized_image, HailoROIPtr roi, GstVideoFormat image_format);
};
