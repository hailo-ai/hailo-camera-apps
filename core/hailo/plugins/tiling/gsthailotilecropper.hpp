...
#define GST_HAILO_TILE_CROPPER(obj)                                                                                    \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_HAILO_TILE_CROPPER, GstHailoTileCropper))
#define GST_HAILO_TILE_CROPPER_CLASS(klass)                                                                            \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_HAILO_TILE_CROPPER, GstHailoTileCropperClass))
