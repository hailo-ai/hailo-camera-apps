...
#define GST_HAILO_TILE_AGGREGATOR(obj)                                                                                 \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_HAILO_TILE_AGGREGATOR, GstHailoTileAggregator))
#define GST_HAILO_TILE_AGGREGATOR_CLASS(klass)                                                                         \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_HAILO_TILE_AGGREGATOR, GstHailoTileAggregatorClass))
