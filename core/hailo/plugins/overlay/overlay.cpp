...
overlay_status_t draw_all(HailoMat &hmat, HailoROIPtr roi, float landmark_point_radius, bool show_confidence,
                          bool local_gallery, const uint mask_overlay_n_threads)
{
    ...
    for (auto obj : roi->get_objects())
    {
        ...
        case HAILO_DETECTION: {
            ...
            // Draw inner objects.
            ret = draw_all(hmat, detection, landmark_point_radius, show_confidence, local_gallery,
                           mask_overlay_n_threads);
            break;
        }
