...
void encode_detection(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                      HailoDetectionPtr detection);
void encode_classification(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                           HailoClassificationPtr classification);
void encode_landmarks(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
...
void encode_unique_id(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                      HailoUniqueIDPtr id);
rapidjson::Value encode_mask(rapidjson::Document::AllocatorType &allocator, HailoMaskPtr mask);
void encode_depth_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                       HailoDepthMaskPtr mask);
void encode_class_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                       HailoClassMaskPtr mask);
void encode_conf_class_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                            HailoConfClassMaskPtr mask);
void encode_matrix(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator, HailoMatrixPtr matrix);
void encode_hailo_objects_to_json(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                                  HailoROIPtr roi);
} // namespace encode_json
...
inline void encode_detection(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                             HailoDetectionPtr detection)
{
...
inline void encode_classification(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                                  HailoClassificationPtr classification)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
inline void encode_landmarks(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                             HailoLandmarksPtr landmarks)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
inline void encode_tile(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                        HailoTileROIPtr tile)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
inline void encode_unique_id(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                             HailoUniqueIDPtr id)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
template <class T> rapidjson::Value encode_mask(rapidjson::Document::AllocatorType &allocator, T mask)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
inline void encode_depth_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                              HailoDepthMaskPtr mask)
{
...
inline void encode_class_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                              HailoClassMaskPtr mask)
{
    rapidjson::Value entry_object = encode_mask(allocator, mask);
...
inline void encode_conf_class_mask(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                                   HailoConfClassMaskPtr mask)
{
    rapidjson::Value entry_object = encode_mask(allocator, mask);
...
inline void encode_matrix(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                          HailoMatrixPtr matrix)
{
    rapidjson::Value entry_object(rapidjson::kObjectType);
...
inline void encode_hailo_objects_to_json(rapidjson::Value &object_json, rapidjson::Document::AllocatorType &allocator,
                                         HailoROIPtr roi)
{
    rapidjson::Value object_array(rapidjson::kArrayType);
