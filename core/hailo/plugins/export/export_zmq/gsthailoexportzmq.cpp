...
static void gst_hailoexportzmq_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec);
static void gst_hailoexportzmq_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec);
...
static GstFlowReturn gst_hailoexportzmq_transform_ip(GstBaseTransform *trans, GstBuffer *buffer);
...
static void gst_hailoexportzmq_class_init(GstHailoExportZMQClass *klass)
{
    ...
    gst_element_class_set_static_metadata(GST_ELEMENT_CLASS(klass), "hailoexportzmq - export element", "Hailo/Tools",
    ...
    g_object_class_install_property(
        ...
        g_param_spec_string("address", "Endpoint address.", "Address to bind the socket to.", "tcp://*:5555",
...
static void gst_hailoexportzmq_init(GstHailoExportZMQ *hailoexportzmq)
{
    hailoexportzmq->address = g_strdup("tcp://*:5555");
    hailoexportzmq->buffer_offset = 0;
}

void gst_hailoexportzmq_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
...
void gst_hailoexportzmq_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
    GstHailoExportZMQ *hailoexportzmq = GST_HAILO_EXPORT_ZMQ(object);
