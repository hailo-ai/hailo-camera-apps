...
static void gst_hailoexportfile_set_property(GObject *object, guint property_id, const GValue *value,
                                             GParamSpec *pspec);
static void gst_hailoexportfile_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec);
...
static GstFlowReturn gst_hailoexportfile_transform_ip(GstBaseTransform *trans, GstBuffer *buffer);
...
static void gst_hailoexportfile_class_init(GstHailoExportFileClass *klass)
{
    ...
    gst_element_class_set_static_metadata(GST_ELEMENT_CLASS(klass), "hailoexportfile - export element", "Hailo/Tools",
    ...
    g_object_class_install_property(
        ...
        g_param_spec_string("location", "Path to export file.", "Location of the JSON file to save", "hailo_meta.json",
...
static void gst_hailoexportfile_init(GstHailoExportFile *hailoexportfile)
{
    hailoexportfile->file_path = g_strdup("hailo_meta.json");
    hailoexportfile->buffer_offset = 0;
}

void gst_hailoexportfile_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
...
void gst_hailoexportfile_get_property(GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
    GstHailoExportFile *hailoexportfile = GST_HAILO_EXPORT_FILE(object);
...
static GstFlowReturn gst_hailoexportfile_transform_ip(GstBaseTransform *trans, GstBuffer *buffer)
{
    ...
    encoded_roi.AddMember("buffer_offset", rapidjson::Value(hailoexportfile->buffer_offset),
                          encoded_roi.GetAllocator());
