...
#define GST_TYPE_HAILO_UPLOAD2 (gst_hailo_upload2_get_type())
#define GST_HAILO_UPLOAD2(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_HAILO_UPLOAD2, GstHailoUpload2))
#define GST_HAILO_UPLOAD2_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_HAILO_UPLOAD2, GstHailoUpload2Class))
#define GST_IS_HAILO_UPLOAD2(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_HAILO_UPLOAD2))
#define GST_IS_HAILO_UPLOAD2_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_HAILO_UPLOAD2))
