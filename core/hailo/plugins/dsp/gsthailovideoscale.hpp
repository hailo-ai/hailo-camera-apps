...
#define GST_TYPE_HAILO_VIDEOSCALE (gst_hailo_videoscale_get_type())
#define GST_HAILO_VIDEOSCALE(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_HAILO_VIDEOSCALE, GstHailoVideoScale))
#define GST_HAILO_VIDEOSCALE_CLASS(klass)                                                                              \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_HAILO_VIDEOSCALE, GstHailoVideoScaleClass))
#define GST_IS_HAILO_VIDEOSCALE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_HAILO_VIDEOSCALE))
#define GST_IS_HAILO_VIDEOSCALE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_HAILO_VIDEOSCALE))
...
#define HAILO_VIDEOSCALE_VIDEO_CAPS GST_VIDEO_CAPS_MAKE(HAILO_VIDEOSCALE_SUPPORTED_FORMATS)
