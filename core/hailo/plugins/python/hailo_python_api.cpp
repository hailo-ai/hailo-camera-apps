...
class __HailoMainObjectGlue : public HailoMainObject, public std::enable_shared_from_this<__HailoMainObjectGlue>
{
  public:
...
class __HailoROIGlue : public HailoROI, public std::enable_shared_from_this<__HailoROIGlue>
{
  public:
    ...
    hailo_object_t get_type() override
    {
        PYBIND11_OVERRIDE(hailo_object_t, HailoROI, get_type);
    }
};

class __HailoTileROIGlue : public HailoTileROI, public std::enable_shared_from_this<__HailoTileROIGlue>
{
  public:
    ...
    hailo_object_t get_type() override
    {
        PYBIND11_OVERRIDE(hailo_object_t, HailoTileROI, get_type);
    }
};

class __HailoDetectionGlue : public HailoDetection, public std::enable_shared_from_this<__HailoDetectionGlue>
{
  public:
...
class __HailoLandmarksGlue : public HailoLandmarks, public std::enable_shared_from_this<__HailoLandmarksGlue>
{
  public:
...
class __HailoMaskGlue : public HailoMask, public std::enable_shared_from_this<__HailoMaskGlue>
{
  public:
...
class __HailoDepthMaskGlue : public HailoDepthMask, public std::enable_shared_from_this<__HailoDepthMaskGlue>
{
  public:
...
class __HailoClassMaskGlue : public HailoClassMask, public std::enable_shared_from_this<__HailoClassMaskGlue>
{
  public:
...
class __HailoMatrixGlue : public HailoMatrix, public std::enable_shared_from_this<__HailoMatrixGlue>
{
  public:
...
class __HailoUniqueIDGlue : public HailoUniqueID, public std::enable_shared_from_this<__HailoUniqueIDGlue>
{
  public:
    ...
    hailo_object_t get_type() override
    {
        PYBIND11_OVERRIDE(hailo_object_t, HailoUniqueID, get_type);
    }
};

class __HailoUserMetaGlue : public HailoUserMeta, public std::enable_shared_from_this<__HailoUserMetaGlue>
{
  public:
    ...
    hailo_object_t get_type() override
    {
        PYBIND11_OVERRIDE(hailo_object_t, HailoUserMeta, get_type);
    }
};
...
HailoTensor tensor_init_full(pybind11::object data, std::string name, uint height, uint width, uint features,
                             float qp_zp, float qp_scale, int type)
{
...
PYBIND11_MODULE(hailo, m)
{
    ...
    m.def("add_classification", &hailo_common::add_classification, "Add classification", "roi"_a, "type"_a, "label"_a,
          "confidence"_a, "class_id"_a = NULL_CLASS_ID);

    m.def("add_detection", &hailo_common::add_detection, "Add detection", "roi"_a, "bbox"_a, "label"_a, "confidence"_a,
          "class_id"_a = NULL_CLASS_ID);

    m.def("add_detections", &hailo_common::add_detections, "Add detections", "roi"_a, "detections"_a);

    m.def("create_flattened_bbox", &hailo_common::create_flattened_bbox, "Create flattened BBOX", "bbox"_a,
          "parent_bbox"_a);

    m.def("flatten_hailo_roi", &hailo_common::flatten_hailo_roi, "Flatten HAILO ROI", "roi"_a, "parent_roi"_a,
          "filter_type"_a);

    m.def("get_hailo_detections", &hailo_common::get_hailo_detections, "Get HAILO detections", "roi"_a);

    m.def("get_hailo_tiles", &hailo_common::get_hailo_tiles, "Get HAILO tiles", "roi"_a);

    m.def("get_hailo_roi_instances", &hailo_common::get_hailo_roi_instances, "Get HAILO ROI instances", "roi"_a);
...

    {
        py::class_<HailoBBox, std::shared_ptr<HailoBBox>>(m, "HailoBBox")
            .def(py::init<float, float, float, float>(), py::arg("xmin"), py::arg("ymin"), py::arg("width"),
                 py::arg("height"))
    ...
    {
        py::class_<HailoMainObject, HailoObject, __HailoMainObjectGlue, std::shared_ptr<HailoMainObject>>(
            m, "HailoMainObject")
            .def(py::init<>())
            ...
            .def("remove_object", py::overload_cast<HailoObjectPtr>(&HailoMainObject::remove_object), "Remove object",
                 "obj"_a)
            .def("remove_object", py::overload_cast<uint>(&HailoMainObject::remove_object), "Remove object", "index"_a)
            ...
            .def("__repr__", [](const HailoMainObject &obj) {
                return "<hailo.HailoMainObject"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" +
                       ">";
            });
    }
    ...
    {
        py::class_<HailoTileROI, HailoROI, __HailoTileROIGlue, std::shared_ptr<HailoTileROI>>(m, "HailoTileROI")
            .def(py::init<HailoBBox, uint, float, float, uint, hailo_tiling_mode_t>(), py::arg("bbox"),
                 py::arg("index"), py::arg("overlap_x_axis"), py::arg("overlap_y_axis"), py::arg("layer"),
                 py::arg("mode"))
            ...
            .def("__repr__", [](const HailoTileROI &obj) {
                return "<hailo.HailoTileROI"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" + ">";
            });
    }

    {
        py::class_<HailoDetection, HailoROI, __HailoDetectionGlue, std::shared_ptr<HailoDetection>>(m, "HailoDetection")
            .def(py::init<HailoBBox, const std::string &, float>(), py::arg("bbox"), py::arg("label"),
                 py::arg("confidence"))
            .def(py::init<HailoBBox, int, const std::string &, float>(), py::arg("bbox"), py::arg("index"),
                 py::arg("label"), py::arg("confidence"))
            .def(py::self < py::self)
            .def(py::self > py::self)
            ...
            .def("__repr__",
                 [](const HailoDetection &obj) {
                     return "<hailo.HailoDetection"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                            ")" + ">";
                 })
            .def(py::pickle(
                [](HailoDetection &self) { // __getstate__
                    return py::make_tuple(self.get_bbox(), self.get_class_id(), self.get_label(), self.get_confidence(),
                ...
                [](py::tuple t) { // __setstate__
                    ...
                    /* Create a new C++ instance */
                    auto instance = std::unique_ptr<HailoDetection>(new HailoDetection(
                        t[0].cast<HailoBBox>(), t[1].cast<int>(), t[2].cast<std::string>(), t[3].cast<float>()));
    ...
    {
        py::class_<HailoClassification, HailoObject, __HailoClassificationGlue, std::shared_ptr<HailoClassification>>(
            m, "HailoClassification")
            .def(py::init<const std::string &, const std::string &, float>(), py::arg("type"), py::arg("label"),
                 py::arg("confidence"))
            .def(py::init<const std::string &, int, const std::string &, float>(), py::arg("type"), py::arg("index"),
                 py::arg("label"), py::arg("confidence"))
            ...
            .def("get_classification_type", &HailoClassification::get_classification_type, "Get classification type")
            .def("get_class_id", &HailoClassification::get_class_id, "Get class")
            .def("__repr__",
                 [](const HailoClassification &obj) {
                     return "<hailo.HailoClassification"s + "(" +
                            std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" + ">";
                 })
            .def(py::pickle(
                [](HailoClassification &self) { // __getstate__
                    return py::make_tuple(self.get_classification_type(), self.get_class_id(), self.get_label(),
                                          self.get_confidence());
                },
                [](py::tuple t) { // __setstate__
                    if (t.size() != 4)
                    ...
                    /* Create a new C++ instance */
                    auto instance = std::unique_ptr<HailoClassification>(new HailoClassification(
                        t[0].cast<std::string>(), t[1].cast<int>(), t[2].cast<std::string>(), t[3].cast<float>()));
    ...
    {
        py::class_<HailoLandmarks, HailoObject, __HailoLandmarksGlue, std::shared_ptr<HailoLandmarks>>(m,
                                                                                                       "HailoLandmarks")
            .def(py::init<std::string, float>(), py::arg("type"), py::arg("threshold"))
            .def(py::init<std::string, std::vector<HailoPoint>, float>(), py::arg("type"), py::arg("points"),
                 py::arg("threshold"))
            .def(py::init<std::string, std::vector<HailoPoint>, float, std::vector<std::pair<int, int>>>(),
                 py::arg("type"), py::arg("points"), py::arg("threshold"), py::arg("pairs"))
            ...
            .def("__repr__",
                 [](const HailoLandmarks &obj) {
                     return "<hailo.HailoLandmarks"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                            ")" + ">";
                 })
            .def(py::pickle(
                [](HailoLandmarks &self) { // __getstate__
                    return py::make_tuple(self.get_landmarks_type(), self.get_points(), self.get_threshold(),
                                          self.get_pairs());
                },
                [](py::tuple t) { // __setstate__
                    if (t.size() != 4)
                    ...
                    /* Create a new C++ instance */
                    auto instance = std::unique_ptr<HailoLandmarks>(
                        new HailoLandmarks(t[0].cast<std::string>(), t[1].cast<std::vector<HailoPoint>>(),
    ...
    {
        py::class_<HailoMask, HailoObject, __HailoMaskGlue, std::shared_ptr<HailoMask>>(m, "HailoMask")
            ...
            .def("__repr__", [](const HailoMask &obj) {
                return "<hailo.HailoMask"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" + ">";
            });
    }

    {
        py::class_<HailoDepthMask, HailoMask, __HailoDepthMaskGlue, std::shared_ptr<HailoDepthMask>>(
            ...
            .def(py::init<std::vector<float>, int, int, float>(), py::arg("data_vec"), py::arg("mask_width"),
                 py::arg("mask_height"), py::arg("transparency"))
            .def_buffer([](HailoDepthMask &obj) -> py::buffer_info {
                return py::buffer_info(const_cast<float *>(obj.get_data().data()), sizeof(float),
                                       py::format_descriptor<float>::format(), 2, {obj.get_height(), obj.get_width()},
                                       {sizeof(float) * obj.get_width(), sizeof(float)});
            })
            .def("get_type", &HailoDepthMask::get_type, "Get type")
            .def("get_data", &HailoDepthMask::get_data, "Get data")
            .def("__repr__",
                 [](const HailoDepthMask &obj) {
                     return "<hailo.HailoDepthMask"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                            ")" + ">";
                 })
            .def(py::pickle(
                [](HailoDepthMask &self) { // __getstate__
                    return py::make_tuple(self.get_data(), self.get_width(), self.get_height(),
                ...
                [](py::tuple t) { // __setstate__
                    ...
                    auto instance = std::unique_ptr<HailoDepthMask>(
                        new HailoDepthMask(std::move(data), t[1].cast<int>(), t[2].cast<int>(), t[3].cast<float>()));
...

    {
        py::class_<HailoClassMask, HailoMask, __HailoClassMaskGlue, std::shared_ptr<HailoClassMask>>(
            ...
            .def(py::init<std::vector<uint8_t>, int, int, float>(), py::arg("data_vec"), py::arg("mask_width"),
                 py::arg("mask_height"), py::arg("transparency"))
            .def_buffer([](HailoClassMask &obj) -> py::buffer_info {
                return py::buffer_info(const_cast<uint8_t *>(obj.get_data().data()), sizeof(uint8_t),
                                       py::format_descriptor<uint8_t>::format(), 2, {obj.get_height(), obj.get_width()},
                                       {sizeof(uint8_t) * obj.get_width(), sizeof(uint8_t)});
            })
            ...
            .def("__repr__", [](const HailoClassMask &obj) {
                return "<hailo.HailoClassMask"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" +
                       ">";
            });
    }

    {
        py::class_<HailoConfClassMask, HailoMask, __HailoConfClassMaskGlue, std::shared_ptr<HailoConfClassMask>>(
            ...
            .def(py::init<std::vector<float>, int, int, float, int>(), py::arg("data_vec"), py::arg("mask_width"),
                 py::arg("mask_height"), py::arg("transparency"), py::arg("class_id"))
            ...
            .def("__repr__", [](const HailoConfClassMask &obj) {
                return "<hailo.HailoConfClassMask"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                       ")" + ">";
            });
    }

    {
        py::class_<HailoMatrix, HailoObject, __HailoMatrixGlue, std::shared_ptr<HailoMatrix>>(m, "HailoMatrix",
                                                                                              py::buffer_protocol())
            .def(py::init<std::vector<float>, uint32_t, uint32_t, uint32_t>(), py::arg("data_ptr"),
                 py::arg("mat_height"), py::arg("mat_width"), py::arg("mat_features"))
            .def_buffer([](HailoMatrix &obj) -> py::buffer_info {
                return py::buffer_info(
                    const_cast<float *>(obj.get_data().data()), sizeof(float), py::format_descriptor<float>::format(),
                    3, {obj.height(), obj.width(), obj.features()},
                    {sizeof(float) * obj.features() * obj.width(), sizeof(float) * obj.features(), sizeof(float)});
            })
            ...
            .def("__repr__", [](const HailoMatrix &obj) {
                return "<hailo.HailoMatrix"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" + ">";
            });
    }

    {
        py::class_<HailoUniqueID, HailoObject, __HailoUniqueIDGlue, std::shared_ptr<HailoUniqueID>>(m, "HailoUniqueID")
            ...
            .def("__repr__",
                 [](const HailoUniqueID &obj) {
                     return "<hailo.HailoUniqueID"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                            ")" + ">";
                 })
            .def(py::pickle(
    ...
    {
        py::class_<HailoUserMeta, HailoObject, __HailoUserMetaGlue, std::shared_ptr<HailoUserMeta>>(m, "HailoUserMeta")
            .def(py::init<>())
            .def(py::init<int, std::string, float>(), py::arg("user_int"), py::arg("user_string"),
                 py::arg("user_float"))
            ...
            .def("__repr__",
                 [](const HailoUserMeta &obj) {
                     return "<hailo.HailoUserMeta"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) +
                            ")" + ">";
                 })
            .def(py::pickle(
                ...
                [](py::tuple t) { // __setstate__
                    ...
                    /* Create a new C++ instance */
                    auto instance = std::unique_ptr<HailoUserMeta>(
                        new HailoUserMeta(t[0].cast<int>(), t[1].cast<std::string>(), t[2].cast<float>()));
    ...
    {
        py::class_<HailoTensor, std::shared_ptr<HailoTensor>>(m, "HailoTensor", py::buffer_protocol())
            .def(py::init(&tensor_init_full), py::arg("data"), py::arg("name"), py::arg("height"), py::arg("width"),
                 py::arg("features"), py::arg("qp_zp"), py::arg("qp_scale"), py::arg("type"))
            .def_buffer([](HailoTensor &obj) -> py::buffer_info {
                return py::buffer_info(obj.data(), sizeof(uint8_t), py::format_descriptor<uint8_t>::format(), 3,
                                       {obj.height(), obj.width(), obj.features()},
                                       {sizeof(uint8_t) * obj.features() * obj.width(),
                                        sizeof(uint8_t) * obj.features(), sizeof(uint8_t)});
            })
            .def("name", &HailoTensor::name, "Name")
            .def("tensor_meta_info", &HailoTensor::tensor_meta_info, "Tensor metadata info")
            ...
            .def("get_full_percision", &HailoTensor::get_full_percision, "Get full percision", "row"_a, "col"_a,
                 "channel"_a, "is_uint16"_a)
            .def("__repr__", [](const HailoTensor &obj) {
                return "<hailo.HailoTensor"s + "(" + std::to_string(reinterpret_cast<unsigned long>(&obj)) + ")" + ">";
            });
    }
    ...
    m.def("access_HailoROI_from_desc", &access_HailoROI_from_desc, "Access HailoROI from low-level py descriptor");
