...
void clip_resnet_50x4(HailoROIPtr roi)
{
    ...
    {
        std::cout << "WARNING: clip_resnet_50x4 total tensor: " << tensors.size() << ", but expecting " << CLIP_RESNET_50X4_EXPECTED_NUM_OUTPUT << std::endl;
        return;
    }
...
void clip_vit_b_32(HailoROIPtr roi)
{
    ...
    {
        std::cout << "WARNING: clip_vit_b_32 total tensor: " << tensors.size() << ", but expecting " << CLIP_VIT_B_32_EXPECTED_NUM_OUTPUT << std::endl;
        return;
    }
