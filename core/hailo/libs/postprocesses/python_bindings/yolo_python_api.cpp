...
PYBIND11_MODULE(yolo, yolo_module)
{
    ...
    yolo_module.def("yolov5_personface_letterbox", &yolov5_personface_letterbox, "Yolov5_personface with letterbox",
                    "roi"_a, "params_void_ptr"_a);
    yolo_module.def("yolov5_vehicles_only", &yolov5_vehicles_only, "Yolov5_vehicles_only", "roi"_a,
                    "params_void_ptr"_a);
    yolo_module.def("yolov5_no_faces_letterbox", &yolov5_no_faces_letterbox, "yolov5_no_faces_letterbox", "roi"_a,
                    "params_void_ptr"_a);
    ...
    yolo_module.def("tiny_yolov4_license_plates", &tiny_yolov4_license_plates, "Tiny_yolov4_license_plates", "roi"_a,
                    "params_void_ptr"_a);
